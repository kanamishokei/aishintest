...
extraContent.greetingRefined = `
  <section id="message" class="greeting-page">
    <header class="greeting-hero-refined">
      <div class="greeting-hero-copy">
        <span class="kicker">Message from the Principal</span>
        <h2>園長あいさつ</h2>
        <p class="principal-name">園長　仲程愛美</p>
        <p class="greeting-lead">神と人を愛し、愛され、<br>一人ひとりがのびのび育つ毎日を。</p>
        <p>愛真幼稚園はキリスト教精神に基づいて幼児教育を担う幼稚園です。「神を愛し、人を愛す心」を教育の基本と考え、神の愛に応えられる子どもたちを育てていきたいと願っています。</p>
      </div>
...
const pageMeta = {
  ...
  'greeting.html': ['園長あいさつ', '園長 仲程愛美からのごあいさつ'],
